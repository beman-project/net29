...
top = []
for toplevel in glob.glob('include/beman/*/*.hpp'):
    top.append(clean_name(toplevel))

all = top.copy()
for detail in glob.glob('include/beman/*/detail/*.hpp'):
    all.append(clean_name(detail))
for dep in glob.glob('build/_deps/*/include/beman/*/*.hpp'):
    all.append(clean_name(dep))
for dep in glob.glob('build/_deps/*/include/beman/*/betail/*.hpp'):
    all.append(clean_name(dep))
